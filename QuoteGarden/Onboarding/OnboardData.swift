...
enum OnboardData {
    ...
    static func buildSet(width: CGFloat = .infinity, height: CGFloat = .infinity) -> OnboardSet {
        ...
        onboardSet.newCard(title: "Reminders", image: "", text: "Unpredictable reminders are a great way to have fun while learning new knowledge", gifInfo: OnboardCard.GifInfo(name: "countdown"))
